...
function draw() {
  ...
  if(gameState === 0){
    ...
    fill("red")
    textSize(20);
    text("ROB THE NATIONAL BANK WITHOUT GETTING CAUGHT",displayWidth/2-285, displayHeight/2-200);
    text("USE THE ARROW KEYS TO MOVE",displayWidth/2-185, displayHeight/2-150);
  
    
    fill("red");
    textSize(30);
    text("PRESS SPACE TO START",displayWidth/2-200, displayHeight/2-100);
...
if(gameState === 2){
  ...
  fill("red");
  textSize(20);
  text("PRESS R TO TRY AGAIN",displayWidth/2-150, displayHeight/2-150);
  
  fill("red");
  textSize(30);
  text("YOU GOT CAUGHT, TRY AGAIN",displayWidth/2-250, displayHeight/2-100);
